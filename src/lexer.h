...
typedef enum {
    PP_TOK_PUNCT_IRSHIFT = 0x101, // >>=
    PP_TOK_PUNCT_ILSHIFT = 0x102, // <<= 
    PP_TOK_PUNCT_VARARGS = 0x103, // ...
    PP_TOK_PUNCT_IADD    = 0x104, // +=
    PP_TOK_PUNCT_ISUB    = 0x105, // -=
    PP_TOK_PUNCT_IMUL    = 0x106, // *=
    PP_TOK_PUNCT_IDIV    = 0x107, // /=
    PP_TOK_PUNCT_IMOD    = 0x108, // %= 
    PP_TOK_PUNCT_IAND    = 0x109, // &=
    PP_TOK_PUNCT_IOR     = 0x10A, // |=
    PP_TOK_PUNCT_IXOR    = 0x10B, // ^=
    PP_TOK_PUNCT_INC     = 0x10C, // ++
    PP_TOK_PUNCT_DEC     = 0x10D, // --
    PP_TOK_PUNCT_RSHIFT  = 0x10E, // >>
