...
// TODO: Current version of fast utf8 decoding does require 4 bytes to be read
// at all times which we don't acciunt for in usage. Either switch to slow
// decoding or pad buffers with additional bytes
