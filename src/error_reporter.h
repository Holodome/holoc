...
void report_message_internalv(string file_contents, source_loc loc, string message_kind, char *msg,
                              va_list args);
...
#define report_warningv_pp_token(_tok, ...) ABSTRACT_REPORT_(_tok, report_warningv, __VA_ARGS__)
